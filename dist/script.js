  ...
  "node_modules/.pnpm/unzipper@0.12.3/node_modules/unzipper/lib/extract.js"(exports2, module2) {
    ...
    function Extract(opts) {
      ...
      outStream._write = async function(entry, encoding, cb) {
        ...
        await fs5.ensureDir(path3.dirname(extractPath));
      ...
      file: function(filename, options) {
        const source = {
          stream: function(start2, length) {
            ...
            return fs5.createReadStream(filename, { start: start2, end });
          },
          size: function() {
            return new Promise(function(resolve, reject) {
...
async function deleteFileOrDir(path3) {
  ...
  if (stat.isDirectory()) {
    (await import_promises.default.readdir(path3)).forEach((e) => {
      deleteFileOrDir(`${path3}/${e}`);
    });
