...
var instructions = (0, import_kolorist.gray)("\u4F7F\u7528\u2191\u2193\u9009\u62E9\uFF0C\u7A7A\u683C\u6216\u2190\u2192\u9009\u4E2D\uFF0Ca\u5168\u9009\uFF0C\u56DE\u8F66\u786E\u8BA4");
var hint = "\u4F7F\u7528\u2191\u2193\u9009\u62E9\uFF0C\u56DE\u8F66\u786E\u8BA4";
function init() {
  ...
  for (let i = 0; i < text.length; i++) {
    ...
    colorText += (0, import_kolorist.bold)(`\x1B[38;2;${red};${green};${blue}m${text[i]}\x1B[0m`);
  }
  const output = import_node_process.default.stdout.isTTY && import_node_process.default.stdout.getColorDepth() > 8 ? colorText : (0, import_kolorist.lightCyan)((0, import_kolorist.bold)(text));
  console.log();
  console.log(output);
  console.log();
...
init().then((result) => {
  ...
  const root = import_node_path.default.join(cwd, res[1]);
  console.log("success");
}).catch((e) => {
  console.log(e);
